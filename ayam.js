...
// --- PERBAIKAN DI SINI: Nama item diubah agar lebih spesifik dan konsisten ---
const itemData = {
    hair: [
        { name: "Chicken Long Hair", price: 30, image: "long ayam.png" },
        { name: "Chicken Curly Hair", price: 30, image: "curly ayam.png" },
        { name: "Chicken Short Hair", price: 30, image: "short ayam.png" }
    ],
    accessories: [
        { name: "Chicken Scarf", price: 30, image: "syal ayam.png" },
        { name: "Chicken Hat", price: 30, image: "hat ayam.png" },
        { name: "Chicken Necklace", price: 30, image: "kalung ayam.png" }
    ],
    playTools: [
