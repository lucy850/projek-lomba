...
// --- PERBAIKAN DI SINI: Variabel ekspresiKucing diubah menjadi ekspresiCat ---
const ekspresiCat = {
...
// --- PERBAIKAN DI SINI: Nama item diubah menjadi 'Cat' ---
const itemData = {
    hair: [
        { name: "Long Cat Hair", price: 30, image: "panjang kucing.png" },
        { name: "Curly Cat Hair", price: 30, image: "curly kucing.png" },
        { name: "Short Cat Hair", price: 30, image: "pendek kucing.png" }
    ],
    accessories: [
        { name: "Cat Scarf", price: 30, image: "syal kucing.png" },
        { name: "Cat Hat", price: 30, image: "topi kucing.png" },
        { name: "Cat Necklace", price: 30, image: "kalung kucing.png" }
    ],
    playTools: [
...
function showExpression(type, duration = 0) {
    ...
    let gambarFinal = ekspresiCat[type]; // Menggunakan ekspresiCat yang sudah diperbaiki
