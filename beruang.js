...
const ekspresiGajah = { // Catatan: Variabel ini masih 'ekspresiGajah' meskipun untuk beruang, ini tidak mempengaruhi fungsionalitas.
    normal: "Bear 1.png",
    love: "bear love.png",
    sad: "bear sad.png"
};

// --- PERBAIKAN DI SINI: Nama item diubah menjadi 'Bear' ---
const itemData = {
    hair: [
        { name: "Long Bear Hair", price: 30, image: "long beruang.png" },
        { name: "Curly Bear Hair", price: 30, image: "curly beruang.png" },
        { name: "Short Bear Hair", price: 30, image: "short beruang.png" }
    ],
    accessories: [
        { name: "Bear Scarf", price: 30, image: "syal beruang.png" },
        { name: "Bear Hat", price: 30, image: "hat beruang.png" },
        { name: "Bear Necklace", price: 30, image: "kalung beruang.png" }
    ],
    playTools: [
